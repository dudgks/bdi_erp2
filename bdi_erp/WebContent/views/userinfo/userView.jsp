		...
		<form action="<%=rPath%>/views/userinfo/userUpdateOK.jsp" onsubmit="return checkVal()">
			<fieldset>
				...
				<table class="table table-bordered">
					...
					<tr>
						<th>유저설명</th>
						<td><textarea name="uiDesc" value=<%=uiDesc %>></textarea>
					</tr>
					<tr>
						<th>나이</th>
						<td><input type="number" name="uiAge" min="1" value=<%=uiAge %>></td>
					<tr>
						<th>부서번호</th>
						<td>
						<input type="number" name="diNo" min="1" max="3" value=<%=uiNo%>><br>
						</td>
					</tr>
